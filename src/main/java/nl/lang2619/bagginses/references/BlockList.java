 ...
 * addFromString() taken and severely edited from chylex with permission
...
public class BlockList {
    ...
    public static void addFromString(String list, String color) {
        ...
        for (String entry : split) {
            ...
            if (itemId[0].equals("ore")) {
                added = SpecifiedOreDict(color, added, dmgs, itemId[1]);
            }
    ...
    private static int SpecifiedOreDict(String color, int added, short[] dmgs, String s) {
        String identifier = s;
